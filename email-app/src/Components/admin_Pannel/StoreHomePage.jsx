...
const StoreHomePage = () => {
    return(
        <div>
            <Container maxW="100%" border="solid #f7fbf5 1px"  bgColor="#f7fbf5" textAlign='center'>
                <Box>
                ...
                <Box ml='25%'>
                    <Image w="75%" src="https://us8.admin.mailchimp.com/release/e/assets/set-up-a-mailchimp-store-1-GV7HKI6S.png" alt="jpg" />
                </Box>
            </Container>

            <Container maxW='100%' border="solid white 1px" bgColor="white" marginTop="-5%">
            <Box w ="80%" 
            ...
            margin="auto" marginTop="20%">
                ...
                {/* <NavLink to="" > */}
                <Box margin="auto" marginTop="100px" marginBottom="20px" textAlign='center'>
                    <Button position="-moz-initial"  className="store-button" border="none" padding="15px 25px 15px 25px" color='white' bgColor="teal" size='sm'> Start Your Store</Button>
                </Box>
                {/* </NavLink> */}

                <Box marginTop="50px" marginBottom="200px" textAlign='center'>
