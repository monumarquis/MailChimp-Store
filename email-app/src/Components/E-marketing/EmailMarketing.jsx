    ...
    <Box pt={40}>
      <Flex>
        <Box className="start_box">
          ...
          <Heading>
            Win customers with the #1 email marketing and autonomations brand *
          </Heading>
          <Text>
            Grow your revenue with targeted and engaging emails that get more
      ...
      <Box w="90%" margin={"auto"}>
        ...
        >
          <div>
            ...
            <Text>
              {" "}
              Get Inspiration from our drag and drop email templates or code
              your own{" "}
            </Text>
          ...
          <div>
            <Image src="https://eep.io/images/yzco4xsimv0y/5DgbjYOTeeyzxQ6510YZ2B/15b296cae9094f71a1cb7faf1e90ba0c/WebOverhaul_EmailOverview_HorizontalGrid03.png?w=302&fm=webp&q=80" />
            <p className="heading">Automations</p>
            <Text>Drive more site traffic and sales with email automation</Text>
            <div>
              <div className="flex">
          ...
          <div>
            ...
            <p className="heading">Analytics & AI</p>
            <Text>
      ...
      {/* <Box bg="#f6f6f4" pb="80px">
        <Heading textAlign="center" pt="80px" mb="40px">
          Find the right plan
        </Heading>
        ...
        <Text fontSize={12} mt="20px" textAlign="center">
