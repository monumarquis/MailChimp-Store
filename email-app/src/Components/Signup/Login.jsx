      ...
      <Flex px={2} >
        ...
        <Image width={10} py={8} src='https://login.mailchimp.com/release/1.1.12db68f65958dbea8011b2efdf4e026e5d28738e2/images/brand_assets/logos/mc-freddie-dark.svg' alt='logo-login'/>
          ...
          <FormControl id="email" position="-moz-initial">
            ...
            <Input type="email" position="-moz-initial" ref={emailRef} />
          </FormControl>
          <FormControl id="password" position="-moz-initial">
            <FormLabel fontWeight={'bold'} >Password</FormLabel>
            <Input type="password" position="-moz-initial" ref={passwordRef} />
          </FormControl>
          <Button size='md' position="-moz-initial" px={8} colorScheme={'teal'} variant={'solid'} disabled={loading} onClick={signin}>
              Log in
            </Button>
